...
class RECORDER:
    ...
    def Handle_Bone(self,bone,i,j):
        ...
        if self.currentNumberOfHands == 2:
            self.gestureData[i, j, 0,self.gestureIndex] = bone.prev_joint.x
            self.gestureData[i, j, 1,self.gestureIndex] = bone.prev_joint.y
            self.gestureData[i, j, 2,self.gestureIndex] = bone.prev_joint.z
            self.gestureData[i, j, 3,self.gestureIndex] = bone.next_joint.x
            self.gestureData[i, j, 4,self.gestureIndex] = bone.next_joint.y
            self.gestureData[i, j, 5,self.gestureIndex] = bone.next_joint.z
